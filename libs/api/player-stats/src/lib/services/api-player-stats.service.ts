  ...
  private async convertStats(array: Players_Stats_V2[]) {
    return await Promise.all(
      array.map((stat: Players_Stats_V2) => ({
        ...stat,
        games_played: parseInt(stat.games_played.toString()),
        goals: parseInt(stat.games_played.toString()),
        assists: parseInt(stat.games_played.toString()),
        points: parseInt(stat.games_played.toString()),
        plus_minus: parseInt(stat.games_played.toString()),
        penalty_minutes: parseInt(stat.games_played.toString()),
        pp_goals: parseInt(stat.games_played.toString()),
        sh_goals: parseInt(stat.games_played.toString()),
        gw_goals: parseInt(stat.games_played.toString()),
        gt_goals: parseInt(stat.games_played.toString()),
        shots: parseInt(stat.games_played.toString()),
        shooting_pct: parseFloat(stat.shooting_pct),
        minutes_played: parseFloat(stat.minutes_played.toString()),
        minutes_per_game: parseFloat(stat.minutes_per_game),
        fo_pct: parseFloat(stat.fo_pct),
        pass_pct: parseFloat(stat.pass_pct),
        corner_pct: parseFloat(stat.corner_pct),
        hits: parseInt(stat.games_played.toString()),
        blocked_shots: parseInt(stat.games_played.toString()),
      }))
    );
  }
}
